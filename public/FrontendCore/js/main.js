(function() {
    var c=" translation", d=" using Google Translate?", e=".", h="Google has automatically translated this page to: ", k="Powered by ", l="Translate", m="Translate everything to ", n="Translate this page to: ", p="Translated to: ", q="Turn off ", r="Turn off for: ", t="View this page in: ", u="var ", v=this;
    function w(a, x) {
        var f=a.split(e), b=v;
        f[0]in b||!b.execScript||b.execScript(u+f[0]);
        for(var g;
        f.length&&(g=f.shift());
        )f.length||void 0===x?b[g]?b=b[g]:b=b[g]= {}
        : b[g]=x
    }
    ;
    var y= {
        0:l, 1:"Cancel", 2:"Close", 3:function(a) {
            return h+a
        }
        , 4:function(a) {
            return p+a
        ...
        , 8:l, 9:"Translation in progress", 10:function(a) {
            return n+(a+d)
        }
        , 11:function(a) {
            return t+a
    ...
    if(z) {
        var A;
        a: {
            for(var B=[], C=["26,0.01,20150908"], D=0;
            D<C.length;
            ++D) {
                ...
                if(F) {
                    ...
                    if(!(!G||.1<G||0>G)) {
                        ...
                        !H||H<J||B.push( {
                            version: F, ratio: G, a: H
                        }
                        )
                    }
                }
            }
            for(var K=0, L=window.location.href.match(/google\.translate\.element\.random=([\d\.]+)/), M=Number(L&&L[1])||Math.random(), D=0;
            D<B.length;
            ++D) {
        ...
        if(z._cjlc)z._cjlc(z._pas+z._pah+O);
        else {
